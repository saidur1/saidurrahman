...
const navigation = [
  ...
  },
  {
    ...
    icon: true,
    submenus: [
      { name: "Accountability Community", href: "/community", current: false },
      {
  ...
  { name: "Login", href: "/login", current: false, icon: false },
];
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <div className="hidden sm:block">
                  <div className="flex ">
                    ...
                    <Link
                      href="/free_training"
                      className="text-gray-300 bg-gray-600 hover:bg-gray-700  rounded-md px-3 py-2 text-sm font-medium "
                    >
                      Free Training
                    </Link>
                  </div>
                      ...
                      <>
                        <Link href={item.href}>
                          <Disclosure.Button className="text-gray-300 hover:bg-gray-700 hover:text-white flex items-center gap-x-[10px] rounded-md px-3 py-2 text-start font-medium w-full">
                            {item.name}
                            {item.icon && <ChevronDownIcon className="text-white h-3 w-3 " />}
                          </Disclosure.Button>
                        </Link>
                        <Disclosure.Panel>
