      ...
      <div className="min-h-[calc(100vh-145px)]  py-[50px] space-y-28 relative container ">
        <section className="flex flex-col-reverse md:flex-row h-auto">
          <div className="flex-1 space-y-8 text-[#333333] mt-[30px] md:mt-0">
            <h1 className="text-[22px] md:text-[30px] lg:text-[40px] font-semibold">
              Join the Accountability Community™ for Consistency, Support, and
              Success!
            </h1>
            <p>
              Dive into a world of growth and achievement! Join the
              Accountability Community on for a supportive space where
        ...
        <section className="text-[#1a1a1a]">
          <h3 className="text-[16px] ">
            ...
            meets camaraderie! Join our server to embark on a transformative
            journey towards achieving your goals. Here, we understand the power
            of accountability, and we've curated a supportive community that
            empowers you to stay consistent and build habits that last.
          </h3>
          <div className="mt-[50px] space-y-14 text-[15px]">
            ...
            <p className="text-[15px]">
              ...
              Accountability Community™. Join us and take the first step towards
              a more accountable, empowered, and fulfilling life. Your journey
