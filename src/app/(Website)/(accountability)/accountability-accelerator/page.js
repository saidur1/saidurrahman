      ...
      <div className="min-h-[calc(100vh-145px)]  py-[50px] space-y-28 relative container ">
        <section className="flex flex-col-reverse md:flex-row h-auto">
          <div className="flex-1 space-y-8 text-[#333333] mt-[30px] md:mt-0">
            <h1 className="text-[22px] md:text-[30px] lg:text-[40px] font-semibold">
              Accountability Accelerator™ for Consistency, Support, and Success!
            </h1>
            <p>
              "Dive into success with our Accountability Accelerator™—your
              shortcut to consistency, unwavering support, and triumph!
              Experience accelerated growth and achievement within a dedicated
              community. This is not just a program; it's your key to
              unstoppable success!"
            </p>
            <div className="mt-4">
              <a
                href="https://www.skool.com/accountability-accelerator"
                target="_skool"
        ...
        <section>
          <h3 className="text-[16px] ">
            ...
            Welcome to our Accountability Accelerator where we empower you to
            achieve your personal and business goals with clarity, commitment,
            and consistent progress. Our comprehensive program is designed to
            provide you with the support and structure needed to enhance your
            focus, productivity, and overall success.
          </h3>
        ...
        <section className=" w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pt-[100px]">
          <div className="p-6">
            ...
            <p className="text-[12px] tracking-wider mt-6">
              Fast-track your goals with our Accountability Accelerator Program.
              Discover top highlights for rapid growth
            </p>
          </div>
          {highlights.map(({ Icon, id, color, title, description }) => (
            <div
            ...
            >
              <div className="flex justify-between items-center">
                ...
                <div>
                  <Icon className={`w-7 h-7 text-[#0000004D]`} />
                </div>
              </div>
              ...
              <div className="p-6 border rounded-sm" key={id}>
                ...
                <div className="space-y-4 mt-2">
                  {options.map(({ id, title, description }) => (
                    <div className="px-8 space-y-2" key={id}>
        ...
        <section>
          <p>
            ...
            , you will receive ongoing bi-weekly calls to provide sustained
            support, ensuring your continued progress. This includes continuous
            refinement of your goals and strategies for optimal results.
            Additionally, you'll have access to a vibrant community and valuable
            resources, fostering continued engagement and providing essential
            support for your long-term success in the program.
          </p>
        </section>
