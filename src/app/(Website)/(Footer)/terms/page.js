        ...
        <WebWrapper>
            <div className="min-h-[calc(100vh-145px)] container pt-6 pb-[80px] bg-white">
                ...
                <div className="mt-[50px] flex flex-col gap-y-[60px]">
                    {content?.map(({ content, title, id, lists, content2 }) => (
